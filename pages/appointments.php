...
<div class="tab-content container-fluid" id="pills-tabContent">
  ...
  <div id="daily-appointments" class="row">
    ...
    ?>
        <div class="col-3 appointment-card mb-4" data-date="<?php echo $row['date']; ?>">
          <div class="card">
            <div class="card-body">
...
<script>
  ...
  function filterAppointmentsByDate(selectedDate) {
    ...
    // Show/hide appointment cards based on the selected date
  ...
  if (typeof today === 'undefined') {
    ...
    let formattedDate = today.toISOString().substr(0, 10); // Format date as "YYYY-MM-DD"
