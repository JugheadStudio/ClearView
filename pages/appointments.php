              ...
              <form action="updateAppointment.php" method="POST">
                ...
                <div class='row mb-3'>
                  <div class="col-6">
                    ...
                    <input type='text' class='form-control isEditing' id='patientID<?php echo $row['id']; ?>' name='patientID' value='<?php echo $patient['name'] . ' ' . $patient['surname']; ?>'>
                  </div>

                  <div class="col-6">
                    <label for='doctorID<?php echo $row['id']; ?>' class='form-label'>Doctor Name</label>
                    <input type='doctorID' class='form-control isEditing' id='doctorID<?php echo $row['id']; ?>' name='doctorID' value='<?php echo $doctor['name'] . ' ' . $doctor['surname']; ?>'>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  <div class="col-6">
                    ...
                    <!-- date input with current value -->
                    <input type="date" class="form-control isEditing" id="date<?php echo $row['id']; ?>" name="date" value="<?php echo $row['date']; ?>" required>
                  </div>
                ...
                <div class="text-end">
                  <?php if ($_SESSION['rank'] == 1) : ?>
                    ...
                    <a class="btn btn-danger isEditingButton" href="deleteAppoinment.php?id=<?php echo $row['id']; ?>">Delete</a>
