  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark sidebar-container">
      ...
      <?php if ($_SESSION['rank'] == 1) : ?>
        <li class="nav-item">
          <a id="receptionistsLink" class="nav-link" onclick="loadContent('receptionists')">
            <i class="fa-solid fa-user"></i> Receptionists
          </a>
        </li>
      <?php endif; ?>
      <li class="nav-item">
    ...
    <div class="row">
      <div class="col text-center">
        ...
        <div class="container-fluid logged-in-user-card mb-3">
          <div class="row">
            <div class="col">
              <img src="<?php echo $profilePicture; ?>" alt="Profile Picture" width="65" height="65" class="rounded-circle logged-in-user-profile-picture mb-3">

              <p class="m-0 logged-in-user-name"><?php echo $name; ?> <?php echo $surname; ?></p>
              <p class="mb-3"><?php echo $username; ?></p>

              <button class="btn btn-outline-light mb-3" type="button" data-bs-toggle="modal" data-bs-target="#signOutModal">Log out</button>
            </div>
          </div>
        </div>
